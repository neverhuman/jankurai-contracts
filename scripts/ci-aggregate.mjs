...
// Adapted from the qualified Hub recovery correction; Contracts has one quality job.
export const requiredParents = Object.freeze(['quality']);
export const requiredJobs = Object.freeze(['quality']);
const repository = 'neverhuman/jankurai-contracts';
...
export function validateExpandedJobs(payload, runId, head, attempt) {
  ...
  for (const job of payload.jobs) {
    ...
    } else if (!['jankurai-contracts/required', 'publish-ci-tag'].includes(job.name)) {
